...
public class Tablero extends JFrame
{
    ...
    private final String start = "dabceifghjnklmo0";
    private final String goal  = "0abcdefghijklmno";
    ...
    private void initComponents() 
    {
        ...
        this.setLayout(null);
        this.imagePieces("imagenes/angryCat.jpg");
        paintPieces();
    ...
    private void imagePieces(String pathName)
    {
        ...
        {      
            ...
            for(int i=0;i<4;i++)
                for(int j=0;j<4;j++)
                {
                    subImage = buffer.getSubimage((j)*124, (i)*124, 124, 124);  // Extrae un fragmento de la imagen
    ...
    public void paintPieces()
    {
        ...
        for(int i=0;i<4;i++)
            for(int j=0;j<4;j++)
            {
                ...
                jBoard[i][j].setBounds(j*124+1, i*124+1,124,124); // Calcula la posición del botón i,j
                this.add(jBoard[i][j]);                                                                        
